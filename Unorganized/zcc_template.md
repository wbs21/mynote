...
English | [한국어](https://github.com/zzossig/hugo-theme-zzo/blob/master/README.ko.md)

Minimum Hugo version changed to 0.65.0 to take advantage of new feature `.GetTerms`. This new feature enable asian languages correctly displayed.
...
- [Features](https://github.com/zzossig/hugo-theme-zzo#features)
- [Minimum Hugo version](https://github.com/zzossig/hugo-theme-zzo#minimum-hugo-version)
- [Installation](https://github.com/zzossig/hugo-theme-zzo#installation)
- [Updating](https://github.com/zzossig/hugo-theme-zzo#updating)
- [Run example site](https://github.com/zzossig/hugo-theme-zzo#run-example-site)
- [Configuration](https://github.com/zzossig/hugo-theme-zzo#configuration)
- [Gallery](https://github.com/zzossig/hugo-theme-zzo#gallery)
- [Contact Page](https://github.com/zzossig/hugo-theme-zzo#contact-page)
- [Talks Page](https://github.com/zzossig/hugo-theme-zzo#talks-page)
- [Showcase Page](https://github.com/zzossig/hugo-theme-zzo#showcase-page)
- [Multi Language](https://github.com/zzossig/hugo-theme-zzo#multi-language)
- [Author](https://github.com/zzossig/hugo-theme-zzo#author)
- [Favicon](https://github.com/zzossig/hugo-theme-zzo#favicon)
- [Customizing](https://github.com/zzossig/hugo-theme-zzo#customizing)
- [External libraries](https://github.com/zzossig/hugo-theme-zzo#external-library)
- [Shortcodes](https://github.com/zzossig/hugo-theme-zzo#shortcodes)
...
First of all, You need to add config files. Follow the [Configuration](https://github.com/zzossig/hugo-theme-zzo#configuration) step.
...
2. config folder structure. Keep in mind the underscore on the `_default` folder
...
1. Next, make some files under the `talks` folder you have created in step 1. If you want to make other link post, then make another file under the `talks` folder.
...
1. Make a category folder and a file at `root/content/showcase/hugo/_index.md`. (In my case, hugo is a category)
...
1. Add a custom style file if you want to change specific colors. [[custom-css](https://github.com/zzossig/hugo-theme-zzo#custom-css)] Then, override chroma class. You can find this class at themes/zzo/assets/sass/syntax folder. Example code is like this.
...
The {} part will be your copyright link. 2. In your params.toml file, set the copyrightOptions params
